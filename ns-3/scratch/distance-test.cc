...
main (int argc, char *argv[])
{
 ...
 // wifiPhyHelper.Set("TxPowerEnd", DoubleValue(5));
  ...
  // positionAlloc->Add (Vector (m, 80.0, 0.0));
...
//---------------------------------------------------------------------------------------
 ...
 // ndnHelper.AddNetDeviceFaceCreateCallback (WifiNetDevice::GetTypeId (), MakeCallback (MyNetDeviceFaceCallback));
  // ndnHelper.AddNetDeviceFaceCreateCallback (WifiNetDevice::GetTypeId (), MakeCallback (MyNetDeviceFaceCallback));
  ndnHelper.SetForwardingStrategy ("ns3::ndn::fw::ndnFw");
  ndnHelper.SetContentStore ("ns3::ndn::cs::Lru", "MaxSize", "30000");
  ...
  consumerHelper.SetAttribute ("StartTime", TimeValue (Seconds (1500)));
