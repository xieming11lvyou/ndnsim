...
//Create by Factory
  ...
  m_factory_server.Set("Number",UintegerValue(numPacket+10));
 ...
 //Must  Create num_server app
  for (int i=0;i<m;i++)
    {
        ...
        app_server->SetStopTime(Seconds(2000.0));
  ...
  app_client->SetStopTime(Seconds(50000.0));
