 ...
 */
class UdpEchoClient1024 : public Application
{
public:
  /**
...
private:
  ...
  uint32_t m_totalReceive;
  uint32_t m_num;//
  Ptr<Socket> m_socket; //!< Socket
  Address m_peerAddress; //!< Remote peer address
  uint16_t m_peerPort; //!< Remote peer port
  EventId m_sendEvent,m_sendEvent1; //!< Event to send the next packet
  bool m_firstTypeRepuest;
  bool flagChoose;
  double  percentage;
  Ipv4Address ipServering,ipNewComing;
